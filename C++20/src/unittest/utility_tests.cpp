...
static HelperData constexpr set2[] = {
    { (UINT64_C(1) << 2u) - 1u, { false, std::make_optional(1), UINT64_C(1) << 1u } },
    { (UINT64_C(1) << 3u) - 1u, { false, std::make_optional(2), UINT64_C(1) << 2u } },
    { (UINT64_C(1) << 4u) - 1u, { false, std::make_optional(3), UINT64_C(1) << 3u } },
    { (UINT64_C(1) << 5u) - 1u, { false, std::make_optional(4), UINT64_C(1) << 4u } },
    { (UINT64_C(1) << 6u) - 1u, { false, std::make_optional(5), UINT64_C(1) << 5u } },
    { (UINT64_C(1) << 7u) - 1u, { false, std::make_optional(6), UINT64_C(1) << 6u } },
};
INSTANTIATE_TEST_SUITE_P(UnderPowers, HelperTests, ::testing::ValuesIn(set2));

static HelperData constexpr set3[] = {
    { (UINT64_C(1) << 1u) + 1u, { false, std::make_optional(1), UINT64_C(1) << 1u } },
    { (UINT64_C(1) << 2u) + 1u, { false, std::make_optional(2), UINT64_C(1) << 2u } },
    { (UINT64_C(1) << 3u) + 1u, { false, std::make_optional(3), UINT64_C(1) << 3u } },
    { (UINT64_C(1) << 4u) + 1u, { false, std::make_optional(4), UINT64_C(1) << 4u } },
    { (UINT64_C(1) << 5u) + 1u, { false, std::make_optional(5), UINT64_C(1) << 5u } },
    { (UINT64_C(1) << 6u) + 1u, { false, std::make_optional(6), UINT64_C(1) << 6u } },
    { (UINT64_C(1) << 7u) + 1u, { false, std::make_optional(7), UINT64_C(1) << 7u } },
};
...
static HelperData constexpr set4[] = {
    ...
    { std::numeric_limits<std::uint8_t>::max(), { false, std::make_optional(7), UINT64_C(1) << 7u } },
    { std::numeric_limits<std::uint16_t>::max(), { false, std::make_optional(15), UINT64_C(1) << 15u } },
    { std::numeric_limits<std::uint32_t>::max(), { false, std::make_optional(31), UINT64_C(1) << 31u } },
    { std::numeric_limits<std::uint64_t>::max(), { false, std::make_optional(63), UINT64_C(1) << 63u } },
    { std::numeric_limits<std::size_t>::max(), { false, std::make_optional(63), UINT64_C(1) << 63u } },
};
