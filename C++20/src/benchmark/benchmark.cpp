...
static inline void BM_testcase(benchmark::State& state)
{
...
template <class BS, char const* NAME>
static inline void BM_testcase2(benchmark::State& state)
{
