...
export module binary_search.range;
import binary_search;

//
// Dynamic and static implementations of binary search by range algorithm
//
...
export {
  ...
  private:
    ...
    [[nodiscard]] inline std::optional<index_t> constexpr withWidth(
