...
export module binary_search.alternative;
import binary_search;

//
// Dynamic and static implementations of binary search by an alternative
// algorithm
//
...
export {
  ...
  private:
    ...
    [[nodiscard]] inline std::optional<index_t> constexpr singleCondition(
