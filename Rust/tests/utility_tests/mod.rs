...
use bs::binary_search::power::utility::{is_power_of_two_or_zero, log2, previous_power_of_two};

impl UtilityTests {
    fn is_power2_correct_answer(_fixture: &UtilityTests, param: &UtilityData) -> TestResult {
        let result: bool = is_power_of_two_or_zero(param.value);
        return assert_eq(result, param.expected_results.is_power_of_2_or_zero);
    }
...
pub const TESTFIXTURE: TestFixture<UtilityTests, UtilityData> = TestFixture {
    ...
    tests: &[
        TestCase {
            name: "is_power2_or_zero_correct_answer",
...
pub const DATASET1: DataSetFixture<UtilityData> = DataSetFixture{
    ...
    dataset: &[
        UtilityData {value: 1usize << 0u32,
                     expected_results: ExpectedResults {is_power_of_2_or_zero: true,
                                                        log2: Some(0u32),
...
pub const DATASET2: DataSetFixture<UtilityData> = DataSetFixture{
    ...
    dataset: &[
        UtilityData {value: (1usize << 2u32) - 1usize,
                     expected_results: ExpectedResults {is_power_of_2_or_zero: false,
                                                        log2: Some(1u32),
                                                        previous_power: 1usize << 1u32,},},
